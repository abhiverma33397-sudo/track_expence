...
export const login = (values) => baseURL.post("UserLogin/login", values);
...
export const verifyOTP = (values) => baseURL.post("UserLogin/verify-otp", values);

export const resetPassword = (values) => baseURL.post("UserLogin/reset-password", values);
